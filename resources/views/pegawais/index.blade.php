        ...
        <div class="card  mx-auto">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div>
                        <a href="{{ route('pegawais.create') }}" class="btn btn-primary mb-2">Create</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Pegawai Jabatan</th>
                            <th scope="col">Pegawai Umur</th>
                            <th scope="col">Pegawai Alamat</th>
